...
var sync = __require(__dirname + '/../system/Sync.coffee');
...
var wait = {
    ...
    //     var resumeCallback=function(err,data,othrData){
    //         if (fiber.callbackAlreadyCalled)
    //             // console.info("WARNING: Callback for function "+fnName+" called twice. Wait.for already resumed the execution.")
    //             return;
    ...
    ,forMethod: function(obj,methodName){ // wait.forMethod(MyObj,'select',....)
        ...
        // newargs.unshift(obj);
        // return method.sync.apply null, newargs
